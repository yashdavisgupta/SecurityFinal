...
function update(response)
{
	...
	jQuery(document).ready(function()
	{
		...
		for(i = 0; i < response.length; i++)
		{
			...
			var str1 = '<input type="button" value="Ping" class="btn waves-effect waves-light" onclick="ping(\'';
			...
			jQuery('#'+response[i].pkey).append('<input type="button" value="Select Server" class="btn waves-effect waves-light" onclick="setCurrentServer('+ response[i].pkey +')">');
